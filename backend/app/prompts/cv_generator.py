...
PHASE_TWO_SYSTEM = (
    ...
    "assembled from ONLY the contact fields supplied in <contact>. "
    "Separate with a middle dot (·). The payload has fixed keys "
    "(email/phone/location/linkedin/github/portfolio) plus an optional "
    "`extra` array of {label, value} items the candidate added "
    "themselves; render those using 'label: value' format. Omit any "
    "field or extra entry that is missing from the payload. Example: "
    "'jane@example.co.uk · +44 7700 900000 · London · "
    "linkedin.com/in/jane-doe · Stack Overflow: stackoverflow.com/u/123'. "
